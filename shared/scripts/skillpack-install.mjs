...
function usage() {
  process.stderr.write(
    [
      ...
      "",
      "Examples:",
      "  # Build and install into a WooCommerce extension repo",
      "  node shared/scripts/skillpack-build.mjs --clean",
      "  node shared/scripts/skillpack-install.mjs --dest=../my-wc-extension --targets=codex,vscode,claude,cursor",
      "",
      ...
      "  node shared/scripts/skillpack-install.mjs --global --skills=abilities-api-implement",
      "",
      "  # Install to project with specific skills",
      "  node shared/scripts/skillpack-install.mjs --dest=../my-wc-extension --targets=claude,cursor --skills=abilities-api-implement",
      "",
    ].join("\n")
  );
}
